...
namespace Lyquidity.Controls.ExtendedListViews
{
    ...
    public class TreeListView : Lyquidity.Controls.ExtendedListViews.ContainerListView
    {
        ...
        public SelectedTreeListNodeCollection SelectedNodes = new SelectedTreeListNodeCollection();
        ...
        public void SelectNode(TreeListNode pNode)
        {
            curNode = pNode;
